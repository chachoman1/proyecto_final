    <header class="oleez-header">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="index.html"><img src="Assets/Plantilla/urbanui/assets/images/logo2.png" alt="davinci"></a>
            <ul class="nav nav-actions d-lg-none ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="#!" data-toggle="searchModal">
                        <img src="Assets/Plantilla/urbanui/assets/images/search.svg" alt="search">
                    </a>
                </li>
